...
import com.tarzan.reptile.utils.EmailAuthenticator;
 ...
 */
public abstract class MicroEmailSystem {
    ...
    static {
        ...
        try {
            inputStream = MicroEmailSystem.class.getResourceAsStream("/email.properties");
            Properties properties = new Properties();
           // properties.load(inputStream);

            authenticator = new EmailAuthenticator();
            String username = "13083633972@163.com";
            authenticator.setUsername(username);

            String password = "a1334512682";
