...
public class JDShop1 {
    ...
    private static String mobileUrl = "https://passport.jd.com/new/login.aspx";
    ...
    private static void userLogin(WebDriver driver) throws Exception {
        ...
        WebElement loginElement = driver.findElement(By.xpath("//div[@class='login-tab login-tab-r']"));
        loginElement.click();
        Thread.sleep(200);//等待0.2秒
        WebElement usernameWebElement = driver.findElement(By.id("loginname"));
        usernameWebElement.sendKeys(username);
        WebElement passwordWebElement = driver.findElement(By.id("nloginpwd"));
        passwordWebElement.sendKeys(password);
        WebElement btnWebElement = driver.findElement(By.xpath("//div[@class='login-btn']"));
        btnWebElement.click();
        Thread.sleep(200);//等待0.2秒
        WebElement draggable = driver.findElement(By.xpath("//div[@class='JDJRV-slide-inner JDJRV-slide-btn']"));//定位元素
